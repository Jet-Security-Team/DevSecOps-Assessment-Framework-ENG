...
![new_model_technology](./images/DAF_model.png)
...
The heatmap shows the degree of practices' implementation within a subdomain across four practice complexity levels (in 
